...
if [ "$ACTION" == "split" ] || [ "$ACTION" == "oneshot" ] ; then
...
if [ "$ACTION" == "postag" ] || [ "$ACTION" == "oneshot" ] ; then
...
if [ "$ACTION" == "postag_filter" ] || [ "$ACTION" == "oneshot" ] ; then
...
if [ "$ACTION" == "corenlp" ] || [ "$ACTION" == "oneshot" ] ; then
...
if [ "$ACTION" == "final" ] || [ "$ACTION" == "oneshot" ] ; then
